...
Make the background for the body black, header dark gray, and sections gray. Add color to the header text. Add a bottom border to the h1 text. Set the font to be a sans-serif font. Right align the footer. Animate the section elements.
