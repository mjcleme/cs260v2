...
```masteryls
{"id":"7bcb0c87-2acf-4c83-8134-20059674a5a2", "title":"Grid demonstration", "type":"ai-web-page", "allowAiPrompt":true, "syncGrade":true, "autoGrade":false, "gradingCriteria":"", "height":500, "file":"grid.html" }
Resize your browser window to see the impact on the grid. Change the min width to be 10px to see how that changes things.
```
