...
You can learn how to use Tailwind in your application with the [Tailwind](../tailwind/tailwind.md) instruction topic.
...
```masteryls
{"id":"e790f0e1-a84b-4046-9149-c1cc0bbdb01f", "title":"Web page development", "type":"ai-web-page", "allowAiPrompt":false, "syncGrade":false, "autoGrade":false, "gradingCriteria":"The word 'byu' must be included in the HTML.", "height":500 }
...
<head>
  ...
  <!-- Bootstrap components loaded from CDN -->
...
<body>
  ...
  <!-- Main content - Component examples -->
  <nav class="container">

    <div class="bd-example">
      <nav aria-label="Page navigation example">
        <ul class="pagination">
          <li class="page-item disabled"><a class="page-link" disabled>Disabled</a></li>
    ...
    <div class="bd-example">
      ...
      <br><br>
      <button type="button" class="btn btn-lg btn-primary" disabled>Large primary button</button>
      <button type="button" class="btn btn-secondary btn-lg" disabled>Large button</button>
      <br><br>
      <button type="button" class="btn btn-sm btn-primary" disabled>Small primary button</button>
    ...
    <div class="bd-example">
      <div class="bd-example">
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            <li><a class="dropdown-item disabled" href="#" disabled>Action disabled</a></li>
          </ul>
        </div>
      </div>
      <div class="bd-example">
      ...
      <div class="bd-example">
        <ul class="dropdown-menu">
          ...
          <li><a class="dropdown-item active" href="#">Action active</a></li>
          <li><a class="dropdown-item" href="#">Action</a></li>
          <li><a class="dropdown-item disabled" disabled>Action disabled</a></li>
        </ul>
      </div>
      <div class="bd-example">
        <div class="btn-group">
    ...
    <div class="bd-example">
      <ul class="list-group">
        <li class="list-group-item active">Item active</li>
        <li class="list-group-item">An item</li>
        <li class="list-group-item">A second item</li>
        <li class="list-group-item">A third item</li>
        <li class="list-group-item disabled">And a disabled one</li>
      </ul>
      <br><br>
    ...
    <div class="bd-example">
      ...
      <div class="bd-example">
        ...
        <div class="tab-content" id="pills-tabContent">
          <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">ills-home-tab</div>
  ...
  <!-- Necessary JavaScript for interactive components -->
