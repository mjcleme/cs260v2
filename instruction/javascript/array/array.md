...
3.  **Reference Type Confusion:** Arrays are objects. When you assign an array to a new variable, you are copying the *reference*, not the data itself. Modifying the new variable will affect the original array.
...
```masteryls
{"id":"js-array-performance", "title":"Array Operation Efficiency", "type":"multiple-choice"}
