...
```masteryls
{"id":"5134acb2-3190-49b2-a22f-c31c1d9b51c2", "title":"URL submission", "type":"url-submission", "urlPrompt":"Convert the user provided URL to create a URL that is the path to the raw GitHub content for the README.md file.", "gradingCriteria":"- the content contains a section named \"HTML Deliverable\"\n- In the \"HTML Deliverable\" section there is a checklist of rubric items.\n- Create a score based on the number of checked items and the description of what was done for each item."}
